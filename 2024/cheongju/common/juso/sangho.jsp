 ...
 //<![CDATA[
   ...
   function changeAreaList(idx, obj){	
	...
	function normalSearch(currentPage){
		...
		var keyword = "";
		var cityText='',countyText='',townText='',orgNm='청주시청 홈페이지',orgCode='173';
		...
		url = "/common/juso/AjaxRequestXML.jsp?getUrl="+escape("http://www.juso.go.kr/link/search.do?extend=true&mode=road_search&searchType=location_buld&topTab=1&engineCtpNm="+encodeURI(cityText)+"&engineSigNm="+encodeURI(countyText)+"&engineEmdNm="+encodeURI(townText)+"&engineBdNm="+encodeURI(trim(form.bdnm.value))+"&currentPage="+currentPage+"&orgCode="+orgCode+"&orgNm="+encodeURI(orgNm));
	...
	function normalSearch2(currentPage){
		var url;
		var form = document.check;
		var orgNm='청주시청 홈페이지',orgCode='173';
		form.currentPage.value =currentPage;

		currentPage=parseInt((currentPage/10)+1);
				   
		url = "/common/juso/AjaxRequestXML.jsp?getUrl="+escape("http://www.juso.go.kr/link/search.do?extend=true&mode=road_search&searchType=location_buld&topTab=1&engineCtpNm="+encodeURI(form.engineCtpNm.value)+"&engineSigNm="+encodeURI(form.engineSigNm.value)+"&engineEmdNm="+encodeURI(form.engineEmdNm.value)+"&engineBdNm="+encodeURI(trim(form.engineBdNm.value))+"&currentPage="+currentPage+"&orgCode="+orgCode+"&orgNm="+encodeURI(orgNm));
	...
	*/
	...
	function setParentValue(newaddr,setDetailJuso){
		...
		document.getElementById("formbox").innerHTML += "<br/><li class='inputdata'><a href='javascript:setOpenerValue(\""+ newaddr+"\")'><img src='http://www.juso.go.kr/images/link/btn_input.gif' alt='' /></a></li>";
		...
		document.getElementById("formbox").innerHTML += "<li class='inputdata'>자세한 표기법은   <a href='http://www.juso.go.kr' style='font-size: 10px'>도로명주소안내홈페이지</a> 를 참조하세요</li>";
	...
	<div id="container">
		<div id="content">
			<ul class="tab">
				...
				<li><a href="#n" onclick="selectSearch('sangho');return false;"><img src="http://www.juso.go.kr/images/link/tab3.gif" alt="건물명"/></a></li>
			</ul>
			
				<div class="form" id="formbox">
				<form name="check" method="post" onsubmit="return false;" action="">
					...
					<fieldset>
						...
						<p class="input" >
							...
							<input type="text" name="bdnm" value="" id="bdnm" class="text" style="width:185px;ime-mode:active" onkeydown="checkKeyASearch();"/>
						 </p>
						</div>
						<div class="btn">
						...
						<div >
							<img src="http://www.juso.go.kr/images/test.gif" alt="" width="380px" />
