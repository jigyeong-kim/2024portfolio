...
String detailAddressId="";

		zipcodeId=request.getParameter("zipcodeId");

		addressId=request.getParameter("addressId");

		detailAddressId=request.getParameter("detailAddressId");
...
%>
            ...
            <head>
                ...
                <title>::지번검색::</title>
                <link type="text/css" href="/common/juso/css/style.css" rel="stylesheet" />
                <script src="/common/juso/script/common.js" type="text/javascript"></script>
                <script type="text/javascript">
                    ...
                    function changeAreaList(idx, obj) {
                        ...
                        var url = "/common/juso/AjaxRequestXML.jsp?getUrl=http://www.juso.go.kr/getAreaCode.do?" + escape(createParameter());
                    ...
                    function normalSearch(currentPage) {
                        ...
                        url = "/common/juso/AjaxRequestXML.jsp?getUrl=" + escape("http://www.juso.go.kr/link/search.do?extend=false&mode=jibun_search&searchType=location_jibun&topTab=1&engineCtpNm=" + encodeURI(cityText) + "&engineSigNm=" + encodeURI(countyText) + "&engineEmdNm=" + encodeURI(townText) + "&engineLiNm=" + encodeURI(riText) + "&engineBdMaSn=" + encodeURI(form.bun1.value) + "&engineBdSbSn=" + encodeURI(form.bun2.value) + "&engineMtYn=" + encodeURI(form.san1.value) + "&currentPage=" + currentPage + "&orgCode=" + orgCode + "&orgNm=" + encodeURI(orgNm));
                    ...
                    function normalSearch2(currentPage) {
                        ...
                        url = "/common/juso/AjaxRequestXML.jsp?getUrl=" + escape("http://www.juso.go.kr/link/search.do?extend=false&mode=jibun_search&searchType=location_jibun&topTab=1&engineCtpNm=" + encodeURI(form.engineCtpNm.value) + "&engineSigNm=" + encodeURI(form.engineSigNm.value) + "&engineEmdNm=" + encodeURI(form.engineEmdNm.value) + "&engineLiNm=" + encodeURI(form.engineLiNm.value) + "&engineBdMaSn=" + form.engineBdMaSn.value + "&engineBdSbSn=" + form.engineBdSbSn.value + "&engineMtYn=" + form.engineMtYn.value + "&currentPage=" + currentPage + "&orgCode=" + orgCode + "&orgNm=" + encodeURI(orgNm));
                    ...
                    */
                    ...
                    function setParentValue(newaddr, setDetailJuso) {
                        ...
                        document.getElementById("formbox").innerHTML += "<li class='popuproad'>상세주소 :&nbsp;<input type='text' id='detail' name ='detail' width='50px' value=''/></li>";
                        ...
                        document.getElementById("formbox").innerHTML += "<li class='inputdata'><a href='javascript:setOpenerValue(\"" + newaddr + "\")'><img src='/common/bio/images/template/juso.gif' alt='' /></a></li>";
                    ...
                    function setOpenerValue(newaddr) {
                        ...
                        window.opener.document.getElementById("<%=zipcodeId%>").value = result[2];

                        window.opener.document.getElementById("<%=addressId%>").value = result[0];

                        window.opener.document.getElementById("<%=detailAddressId%>").value = document.getElementById("detail").value;
                    ...
                    function selectSearch(mode) {
                        ...
                        if (mode == 'road') {
                            ...
                            document.location.href = "/common/juso/road.jsp?zipcodeId=<%=zipcodeId%>&addressId=<%=addressId%>&detailAddressId=<%=detailAddressId%>";

                        } else if (mode == 'jibun') {

                            document.location.href = "/common/juso/jibun.jsp?zipcodeId=<%=zipcodeId%>&addressId=<%=addressId%>&detailAddressId=<%=detailAddressId%>";

                        } else if (mode == 'sangho') {

                            document.location.href = "/common/juso/sangho.jsp?zipcodeId=<%=zipcodeId%>&addressId=<%=addressId%>&detailAddressId=<%=detailAddressId%>";
                            ...
                            <div class="form" id="formbox">
								...
								<option value="">::선택::</option>
                                            ...
                                            <p class="input">
                                                ...
                                                <input type="text" name="bun1" value="" id="bun1" class="text" style="width:84px" onfocus="javascript:focusItem(this);" onkeydown="checkKeyASearch();" /> -
                                                <input type="text" name="bun2" value="" id="bun2" class="text" style="width:84px" onfocus="javascript:focusItem(this);" onkeydown="checkKeyASearch();" />
                                            </p>
                                        </div>
                                        <div class="btn"> <a href="#"><img src="http://www.juso.go.kr/images/link/btn_search.gif" alt="검색" onclick="normalSearch('1');return false;" /></a> </div>
                                        <div> <img src="http://www.juso.go.kr/images/test.gif" alt="" width="380px" /> 자세한 표기법은 <a href="http://www.juso.go.kr" style="font-size: 10px" target="_blank">도로명주소안내홈페이지</a> 를 참조하세요 </div>
                                    </fieldset>
                                </form>
                            </div>
                        </div>
