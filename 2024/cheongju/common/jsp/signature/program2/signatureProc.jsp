...
<%
	...
	String memo = (String)request.getParameter("memo") != null ? (String)request.getParameter("memo") : "";
	...
	if(!name.equals("") || !address.equals("") || !memo.equals("")) {
		...
		try{
			...
			*/
			...
			String sql = "INSERT INTO SIGNATURE2 (SIGNATURE_NO, NAME, ADDRESS, MEMO, RDATE) VALUES (SIGNATURE_NO2_SEQ.NEXTVAL,?,?,?,?)";        // sql 쿼리
...
<script type="text/javascript">
	...
	if(chk == "Y") {
		alert("참여해 주셔서 감사합니다.");
		location.href = "http://<%=domainURL%>/www/contents.do?key=7682&amp;complate=Y";
	} else {
		alert("처리중 오류가 있습니다.");
		location.href = "http://<%=domainURL%>/www/contents.do?key=7682";
	}
</script>
