...
//<![CDATA[	
	...
	function validateSignature(obj)
	{
		...
		var chkMemo = obj.memo.value; //남기는한마디
...
%>
<div class="text_center margin_b_20 m_box_s"> <img src="/www/images/contents/7682_tit_img.gif" alt="국립철도박물관청주유치를 위한 서명운동에 동참해주세요" /></div>
<img src="/www/images/contents/7682.gif" alt="서울외곽순환고속도로 북부구간 통행료" /><br/><br/>
...
<em class="large">국립철도박물관청주유치를 위한 서명운동</em><br />
...
<em class="em_b_black">서명참여기간 : 2016. 5. 23 ~ 12. 31</em>
</div>
...
%>
	<div class="text_center">
		<img src="/www/images/contents/cts_7649_img1.jpg" alt="감사합니다 서명이 완료되었습니다. 50만청주시민 서명운동에 동참해 주셔서 감사합니다." />
	</div>
<%
	} else { //참여전 보여주는 신청 폼
%>
	<div class="right margin_r_20">
	<span><em class="em_red">※ 주소는 동까지만 기재</em></span>
</div>
<div class="text_left">
<em class="large">[온라인 서명부]</em>
</div>
	<form name="signatureForm" id="signatureForm" method="post" action="/common/jsp/signature/program2/signatureProc.jsp">
		<table class="txt">
			<tr>
...
%>
		...
		<table class="txt">
			<tr>
				<td bgcolor='#dbdbdb' width="19%">3.남기는 한마디</td>
				<td style="padding:5px;"><input type="text" id="memo" name="memo" title="남기는 한마디 입력" style="width:550px;"/></td>
			</tr>
		</table>
...
<%
	...
	//시작일자
	java.util.Date s_Date = format.parse("20160523000000"); //Date 형
...
<a href="#n" onclick="validateSignature(document.signatureForm); return false;" class="blue_btn"><span class="voticon">서명완료</span></a>
...
<c:if test="${_ROLE_TYPE_ eq 'ROLE_MANAGER'||_ROLE_TYPE_ eq 'ROLE_ADMIN'}">
	<a class="download_btn" title="엑셀 다운로드[새창]" target="_blank" href="/common/jsp/signature/program2/signatureExcel.jsp"><span class="downicon">서명리스트 엑셀저장</span></a>
</c:if>
