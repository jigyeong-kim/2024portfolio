...
<%
	...
	try{
		...
		*/
		...
		//동 리스트 쿼리
		String sql = "SELECT signature_no, name, address, tel, rdate FROM signature ORDER BY signature_no desc";        // sql 쿼리
...
%>
		<tr>
			...
			<td><%= name %></td>
			<td><%= address %></td>
			<td style='mso-number-format:"\@";'><%= tel %></td>
