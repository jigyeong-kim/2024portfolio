...
npmsApiRequestInfo.apiKey = "2013efab6225e54a68b9a3fa7b970051d3e8";//apiKey - NCPMS에서 신청 후 승인되면 확인 가능
npmsApiRequestInfo.serviceCode = "SVC11"; // 사진검색 1의 서비스코드(상세한 내용은 Open API 이용안내 참조)

npmsApiRequestInfo.callback = "http://www.cheongju.go.kr/common/farming/dgnss_ajax_local_callback.jsp";//Call Back URL : 제공하는 callBack 페이지를 서버에 배포후 해당 경로를 적용
