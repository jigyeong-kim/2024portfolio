...
//
;if(jQuery) (function($) {
    $.fn.contextMenu = function(o, callback) {
        // Defaults
        if(o.menu == undefined)
            return false;
        ...
        $(this).each(function() {
            ...
            $(this).mousedown(function(e) {
                ...
                $(this).mouseup(function(e) {
                    ...
                    if(evt.which == null) {
                        /* IE case */
                        _button = (evt.button < 2) ? "LEFT" : ((evt.button == 4) ? "MIDDLE" : "RIGHT");
                    } else {
                        /* All others */
                        _button = (evt.which < 2) ? "LEFT" : ((evt.which == 2) ? "MIDDLE" : "RIGHT");
                    }
    ...
    $.fn.disableContextMenuItems = function(o) {
        if(o == undefined) {
            // Disable all
    ...
    $.fn.enableContextMenuItems = function(o) {
        if(o == undefined) {
            // Enable all
