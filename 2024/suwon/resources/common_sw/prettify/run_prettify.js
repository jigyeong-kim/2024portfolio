    ...
    */
    (function () {
        ...
        for (B = H.length; l < B; ++l)(function () {
            ...
            g.src = "prettify/lang-" + encodeURIComponent(H[l]) + ".js";
            N.insertBefore(g, N.firstChild)
        })(H[l]);
        for (var S = H.length, F = [], l = 0, B = P.length; l < B; ++l) F.push("/resources/common_sw/prettify/skins/" + encodeURIComponent(P[l]) + ".css");
