 ...
 * @constructor
 */
var Slide = function(selector, slideCount, slideControl, slideList, stepSize, animateSpeed, intervalTime, autoPlay, loop, direction, type, stepCount) {
...
Slide.prototype = {
    ...
    _init: function() {
        ...
        // 목록 전체 수
        this._slideTotal = parseInt(this._$slideItem.length / this._stepCount, 10);
        if( !this._slideTotal ) {
            return false;
        }
    ...
    _slideNext: function() {
        ...
        if( slided ) {
            ...
            this._animated = true;
            // 슬라이드 위치 조정함
            this._slidePosition = -(this._stepSize*this._stepCount);
            // 슬라이드 함!!!
            this._slidePlay();
