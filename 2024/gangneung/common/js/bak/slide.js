...
Slide.prototype = {
    ...
    _init: function() {
        ...
        // 버튼 타이블 변경 및 활성화상태 변경
        this._slideButtonControl();
    },
    ...
    _slideNext: function() {
        ...
        if( slided ) {
            ...
            if (parseInt(this._$slideList.css(this._basePosition),10) !== 0) {
                // 맨 앞에 슬라이드 복사함
     ...
     * @private
     */
    _slideButtonControl: function() {
        if( 0 === this._slideNumber ) {
            this._$slideControlPrev.html("<span><i></i></span>").hide();
            this._$slideControlNext.html("<span><i></i></span>" + this._$slideList.find(".study2 .ti a").html()).show();
        } else if( (this._slideTotal - 1) === this._slideNumber ) {
            this._$slideControlPrev.html("<span><i></i></span>" + this._$slideList.find(".study" + ( this._slideNumber ) + " .ti a").html()).show();
            this._$slideControlNext.html("<span><i></i></span>").hide();
        } else {
            this._$slideControlPrev.html("<span><i></i></span>" + this._$slideList.find(".study" + ( this._slideNumber ) + " .ti a").html()).show();
            this._$slideControlNext.html("<span><i></i></span>" + this._$slideList.find(".study" + ( this._slideNumber + 2) + " .ti a").html()).show();
        }
    },
