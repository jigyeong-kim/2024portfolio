<%@ page contentType="text/html;charset=utf-8"%><%
	...
	*/
    ...
    upload.SetTempPath(request.getSession().getServletContext().getRealPath("/DATA/temp"));
    ...
    upload.SetPhysicalPath(request.getSession().getServletContext().getRealPath("/DATA/dext5uploaddata"));
