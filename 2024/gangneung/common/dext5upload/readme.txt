...
* 설치규격
	...
	- 지원 웹 언어 : JSP JDK 1.4.2 이상, ASP, ASP.NET 2.0 이상
	- 지원 웹 서버 : JDK 1.4.2 이상을 사용하는 WAS, Microsoft .NET Framework 2.0 이상을 사용하는 IIS
...
* DEXT5 Upload 폴더 설명
	...
	- sample
		DEXT5 Upload의 기본 예제들을 포함하고 있습니다. (테스트 완료후 삭제 하십시오)
