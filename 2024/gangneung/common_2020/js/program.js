...
function(factory) {
    ...
    Datepicker.prototype = {
        ...
        _fill_yearsView: function(selector, cssClass, factor, year, startYear, endYear, beforeFn) {
            ...
            var titleText = "이동 없음";
            100 == step ? view.find(".p-datepicker-switch").text(startVal + dates[this.o.language].yearCentury + " - " + endVal + dates[this.o.language].yearCentury).attr("title", titleText) : 10 == step ? (3 < this.o.maxViewMode && (titleText = "100년단위 연도 선택 이동"), 
            view.find(".p-datepicker-switch").text(startVal + dates[this.o.language].yearCentury + " - " + endVal + dates[this.o.language].yearCentury).attr("title", titleText)) : (2 < this.o.maxViewMode && (titleText = "10년단위 연도 선택 이동"), 
...
$(function() {
    ...
    }, $.fn.madalPop = modalPlugin, $.fn.madalRemotePop = modalRemotePlugin, $(document).on("click.modal", "[data-button='modal']", function(e) {
        e.preventDefault();
        var $this = $(this), option = $this.data();
        $this.attr("href");
    ...
    Accordion.prototype.show = function() {
        ...
        element.addClass("active"), display && (element.show(), element.attr("title", "열림"));
    }, Accordion.prototype.disabled = function(element, display) {
        element.removeClass("active"), display && (element.hide(), element.attr("title", "숨김"));
